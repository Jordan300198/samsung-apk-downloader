...
All data (devices, CSCs, packages) is embedded — no external file needed.
"""
...
# ═══════════════════════════════════════════════════════
#  CONSTANTS — embedded from samsung_apk_downloader.py
# ═══════════════════════════════════════════════════════

API_URL = "https://vas.samsungapps.com/earth/stub/stubDownload.as"
API_CATEGORY_URL = "https://vas.samsungapps.com/product/getContentCategoryProductList.as"
API_UPDATE_CHECK_EX_URL = "https://vas.samsungapps.com/stub/stubUpdateCheckEx.as"
...
class GalaxyStoreClient:
    ...
    def query(self, package: str, model: str, sdk: int,
              csc: str = "DBT", mcc: str = "262", mnc: str = "01") -> dict:
        params = {
            "appId": package, "deviceId": model, "mcc": mcc, "mnc": mnc,
            "csc": csc, "sdkVer": str(sdk), "abiType": "64",
